...
export function useHotkeys({ onNext, onPrev, onTogglePause, onToggleSpectrum, onToggleTrackOverlay }: Handlers) {
  useEffect(() => {
  ...
  }, [onNext, onPrev, onTogglePause, onToggleSpectrum, onToggleTrackOverlay])
}
